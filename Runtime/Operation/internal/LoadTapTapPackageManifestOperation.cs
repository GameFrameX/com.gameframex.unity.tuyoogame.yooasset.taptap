...
namespace YooAsset.TapTap
{
    ...
    internal class LoadTapTapPackageManifestOperation : AsyncOperationBase
    {
        [UnityEngine.Scripting.Preserve]
        private enum ESteps
        {
        ...
        [UnityEngine.Scripting.Preserve]
        internal LoadTapTapPackageManifestOperation(TaptapFileSystem fileSystem, string packageVersion, string packageHash, int timeout)
        {
        ...
        {
            _requestCount = WebRequestCounter.GetRequestFailedCount(_fileSystem.PackageName, nameof(LoadTapTapPackageManifestOperation));
        ...
        public override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.RequestFileData)
            {
                ...
                else
                {
                    ...
                    WebRequestCounter.RecordRequestFailed(_fileSystem.PackageName, nameof(LoadTapTapPackageManifestOperation));
                }
            }
            ...
            if (_steps == ESteps.VerifyFileData)
            {
                ...
                else
                {
                    _steps = ESteps.Done;
                    Status = EOperationStatus.Failed;
                    Error = "Failed to verify taptap package manifest file!";
                }
            }
